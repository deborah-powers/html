function goCrop(){
	...
	const screen = document.getElementById ('crop-screen');
...
function resetCropSimple(){
	imageRef.xo =0;
	imageRef.xu =100;
	imageRef.yo =0;
	imageRef.yu =100;
	movingInputs[0].value = '0%';
	movingInputs[1].value = '100%';
	movingInputs[2].value = '0%';
	movingInputs[3].value = '100%';
	movingLines[0].x1.baseVal.valueAsString = '0%';
	movingLines[0].x2.baseVal.valueAsString = '0%';
	movingLines[1].x1.baseVal.valueAsString = '100%';
	movingLines[1].x2.baseVal.valueAsString = '100%';
	movingLines[2].y1.baseVal.valueAsString = '0%';
	movingLines[2].y2.baseVal.valueAsString = '0%';
	movingLines[3].y1.baseVal.valueAsString = '100%';
	movingLines[3].y2.baseVal.valueAsString = '100%';
}
function resetCrop(){
	resetCropSimple();
...
function validateCrop(){
	...
	// récupérer les bornes de cadrage
